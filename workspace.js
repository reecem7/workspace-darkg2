...
cprequire_test(["inline:com-chilipeppr-workspace-darkg2"], function(ws) {
    ...
    $('title').html("darkG2 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-darkg2", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-darkg2", // Make the id the same as the cpdefine id
        name: "Workspace / darkG2 ", // The descriptive name of your widget.
        ...
        // githuburl:"https://github.com/reecem7/workspace-darkg2",
